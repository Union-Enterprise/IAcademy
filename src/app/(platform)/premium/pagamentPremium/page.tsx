      ...
      <div className="mb-4">
        <div className="shadow-lg p-4 rounded-lg flex justify-between items-center">
            <div className='flex justify-between'>
                <BaggageClaim className='text-mainBlue'/><h2 className="text-lg font-bold ml-2">Meus itens</h2>
            </div>
        ...
        <div className="shadow-lg p-4 rounded-lg">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              ...
              <div className="mt-2 space-y-2">
                <div className="flex justify-between items-center p-4 bg-gray-100 rounded-lg border-2 hover:border-mainBlue transition-200">
                  <CreditCard className='text-mainBlue'/> <span>Cartão de Crédito</span>
                  <div className="flex items-center">
                ...
                <div className="flex justify-between items-center p-4 bg-gray-100 rounded-lg border-2 hover:border-mainBlue transition-200">
                  <Barcode className='text-mainBlue'/><span>Boleto</span>
                  <div className="flex items-center">
                ...
                <div className="flex justify-between items-center p-4 bg-gray-100 rounded-lg border-2 hover:border-mainBlue transition-200">
                  <HandCoins className='text-mainBlue'/><span>Pix</span>
                  <div className="flex items-center">
            ...
            <div>
              ...
              <div className="mt-2 space-y-2">
                <div className="flex justify-between items-center p-4 bg-gray-100 rounded-lg border-2 hover:border-mainBlue transition-200">
                  <SmartphoneNfc className='text-mainBlue mr-5'/><span>PayPal</span>
                  <div className="flex items-center">
