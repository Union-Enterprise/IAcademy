            ...
            <form className="flex flex-col gap-y-16 mb-10">
                <div className="flex justify-between gap-10 w-full">
                    <textarea
                        ...
                        className="border rounded-md p-2 w-full mb-4 focus:border-mainBlue focus:shadow-md hover:border-mainBlue hover:shadow-md focus:outline-none border-zinc-400"
                        rows={2}
                    />
                </div>
            </form>
