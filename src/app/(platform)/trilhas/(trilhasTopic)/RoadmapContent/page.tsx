...
const RoadmapEstatisc = () => {
  return (
    <div className="bg-bg-lightA" style={{ height: "100vh", width: "100%", display: "flex", justifyContent: "center", alignItems: "center" }}>
      <div className="bg-bg-lightA" style={{ height: "60vh", width: "90%" }}>
        <ReactFlow nodes={nodes} edges={edges} style={{ background: "#F5F5F5" }}>
          <Controls />
        </ReactFlow>
      </div>
    </div>
