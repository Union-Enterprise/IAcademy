...
import SettingsCPF from "@/app/ui/components/profile/SettingsCPF";
        ...
        <>
            ...
            <SettingsSection>
                <div className="flex items-center gap-5 mb-5">
                    <UsersRound />
                    <h3 className="font-bold text-xl">Dados de Usuário</h3>
                </div>
                ...
                <div className="flex gap-4">
                    <div className="w-1/3 flex flex-col">
                        <label className="text-whiteText mb-3">Nascimento</label>
                        <div className="relative flex items-center overflow-hidden rounded-md">
                            <input
                                type="text"
                    ...
                    <div className="w-1/3 flex flex-col">
                        ...
                        <div className="relative flex items-center overflow-hidden rounded-md">
                            <select
                                className="w-full p-[10px] border-2 rounded-md focus:outline-none focus:border-mainBlue hover:border-mainBlue peer duration-100 bg-white text-black appearance-none"
                            >
            ...
            {emailView && <SettingsCPF closeView={() => setEmailView(false)} />}
            {passwordView && <SettingsCPF closeView={() => setPasswordView(false)} />}
