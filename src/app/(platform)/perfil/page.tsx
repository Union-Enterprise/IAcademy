...
import { UserRound, BadgeCheck, KeyRound, Mail, LockKeyhole, User} from 'lucide-react';
    ...
    return (
        ...
        <div className="max-w-4xl mx-auto  rounded-lg p-6">
          ...
          <div className="border p-4 rounded-lg mb-6">
            ...
            <div className="flex gap-1 items-center mb-2">
              <Mail className="w-5"/>
              <p className="text-gray-600">kaua.souza.santos@gmail.com</p>
            </div>
          ...
          <div/>
            <div className="flex gap-1 items-center mb-1">
              <p className="text-gray-600">Kauã de Souza</p>
            </div>
            <a href="#" className="text-blue-500">Alterar</a>
          </div>
          <div className="border p-3 rounded-lg mb-6">
